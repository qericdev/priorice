...
function Partner() : JSX.Element{
    return (
        <section className={styles.partner}>
            ...
            <p>We do not yet have humble partners but we are open to a strategic alliance, with trusting leaders that think strategically. Businessmen and women who believe in the change they&apos;re making, embrace their mission and want to bring in a partner to accelerate their growth. Your logo could be here.</p>
